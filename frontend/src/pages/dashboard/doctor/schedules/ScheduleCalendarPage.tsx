...
export default function ScheduleCalendarPage() {
    ...
    if (error) return <p>Error al cargar los horarios...</p>

    return (
        <div>
            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 space-y-5">
                <div>
                    <h2 className="text-2xl font-bold text-gray-800 mb-2">Configuración de Horarios Semanales</h2>
                    <p className="text-gray-600">Defina los días y las horas de atención general para la generación automática de slots.</p>
                </div>
