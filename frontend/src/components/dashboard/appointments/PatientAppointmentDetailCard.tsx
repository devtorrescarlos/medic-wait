...
interface PatientAppointmentDetailCardProps {
  appointment: Appointment;
  handleCancelModal: () => void;
  handleConfirmModal: () => void;
}

export default function PatientAppointmentDetailCard({
  appointment,
  handleCancelModal,
  handleConfirmModal,
}: PatientAppointmentDetailCardProps) {
  const status =
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <AppointmentCardItems
            initials={
              <UserInitialts name={appointment.doctor.full_name} size="large" />
            }
            iconBgColor="bg-gray-100"
            icon={<Stethoscope className="w-6 h-6 text-gray-500" />}
            title="Doctor"
            description={`Dr. ${appointment.doctor.full_name}`}
          />
          ...
          <AppointmentCardItems
            ...
            title="Correo"
            description={appointment.doctor.full_name}
          />
