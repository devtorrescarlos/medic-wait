...
export default function Sidebar({ isSidebarCollapsed, setIsSidebarCollapsed }: SidebarProps) {
    ...
    const ADMIN_LINKS = [
        ...
        { to: "/dashboard/admin/users", label: "Usuarios", icon: "M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" },
        { to: "/dashboard/admin/doctors", label: "Doctores", icon: "M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" },
        { to: "/dashboard/admin/appointments", label: "Citas", icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" },
    ];

    const DOCTOR_LINKS = [
        { to: "/dashboard/doctor", label: "Dashboard", icon: <House /> },
        { to: "/dashboard/doctor/schedule", label: "Mi Calendario", icon: <CalendarArrowUp /> },
        { to: "/dashboard/doctor/slots", label: "Slots", icon: <Clock4 /> },
        { to: "/dashboard/doctor/appointments", label: "Citas", icon: <Calendar /> },
        { to: "/dashboard/doctor/patients", label: "Pacientes", icon: <User2 /> },
    ];

    const PATIENT_LINKS = [
        { to: "/dashboard/patient", label: "Mis Citas", icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" },
        { to: "/dashboard/patient/book", label: "Reservar Cita", icon: "M12 6v6m0 0v6m0-6h6m-6 0H6" },
        ...
        `}>
            ...
            `}>
                <div className={`flex items-center gap-3 ${isSidebarCollapsed ? "justify-center" : ""}`}>
                    ...
                    {!isSidebarCollapsed && (
                        <span className="text-lg font-bold text-gray-800 whitespace-nowrap">MedicWait</span>
                    )}
                </div>
            </div>
