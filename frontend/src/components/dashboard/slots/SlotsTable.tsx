                ...
                {filteredSlots.map((slot) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <span
                        className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${slot.is_available ? "bg-emerald-100 text-emerald-800" : "bg-gray-100 text-gray-800"}`}
                      >
                    ...
                    <td className="px-4 py-3 text-sm text-gray-600 text-center">
                      {slot.date
                        ? formatDate(slot.date) +
                          " - " +
                          formatDay(slot.schedule.day_of_week)
                        : "-"}
                    </td>
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center justify-center gap-2">
                        <Link
                          to={`/dashboard/doctor/slots/edit/${slot.id}`}
                          className="p-1.5 text-gray-500 hover:text-cyan-600 hover:bg-red-50 rounded-lg transition-colors"
                        >
                          <Pencil size={16} />
                        </Link>
                        <button
