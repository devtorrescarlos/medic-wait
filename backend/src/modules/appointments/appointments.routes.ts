...
import { verifyDoctorApproved, verifyPatient } from "../../middlewares/verifyRole";
...
router.post("/:appointmentId/confirm",
    authenticate,
    param("appointmentId")
        .isUUID()
        .withMessage("El id de la cita debe ser un uuid")
...
router.get("/patient/:patientId",
    ...
    handleInputErrors,
    verifyDoctorApproved, appointmentController.getAppointmentsByPatientId)
